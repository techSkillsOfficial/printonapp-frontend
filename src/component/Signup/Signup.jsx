...
export function Signup() {
  ...
  useEffect(() => {
    ...
    const checkEmailExists = async () => {
      try {
        const response = await axios.get(`https://printonapp-backend-production.up.railway.app/users/IsEmailExists?email=${formData.email}`);
...
console.log("isFormTouched",isFormTouched)
  ...
  useEffect(() => {
    const fetchColleges = async () => {
      try {
        const response = await axios.get('https://printonapp-backend-production.up.railway.app/homepage/colleges');
