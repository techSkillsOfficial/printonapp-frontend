  ...
  const itemsData = [
    {
      ...
      imageUrl: 'https://unsplash.com/photos/jDKT2uV6I3w/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8Mnx8dGhlc2lzfGVufDB8fHx8MTcwNjI2NTY2NXww&force=true',
    },
    {
      title: 'Coming Soon!!!',
      imageUrl: 'https://images.unsplash.com/photo-1614332287897-cdc485fa562d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y29taW5nJTIwc29vbnxlbnwwfHwwfHx8MA%3D%3D',
    }, {
      title: 'Coming Soon!!!',
      imageUrl: 'https://images.unsplash.com/photo-1614332287897-cdc485fa562d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y29taW5nJTIwc29vbnxlbnwwfHwwfHx8MA%3D%3D',
    }, {
        ...
        <div className='p-20'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {itemsData.map((item, index) => (
              <Item key={index} title={item.title} imageUrl={item.imageUrl} />
            ))}
          </div>
        </div>
