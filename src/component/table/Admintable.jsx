        ...
        <div className="grid sm:grid-cols-12 grid-cols-6 gap-1 min-h-screen ">
            <div className="sm:col-span-12 col-span-4 border border-gray-100">
                                        ...
                                        <tbody className="divide-y divide-gray-200 bg-white">
                                            {thesis.map((person) => (
                                                <tr key={person.id}>
                                                        ...
                                                        {editingId === person.id ? (
                                                            <textarea
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    setThesis(prevThesis => prevThesis.map(item => item.id === person.id ? { ...item, description: newDescription } : item));
                                                                }}
                                                    ...
                                                    <td className="whitespace-nowrap px-4 py-4">
                                                        <Link to={person.pdf} target="_blank" rel="noopener noreferrer">
                                                            <img
                                                                width="25"
                                                                height="25"
                ...
                <div className="flex justify-center mt-4">
                    ...
                    <span className="mr-2">{currentPage} / {totalPages}</span>
                    <button
                        onClick={() => handlePageChange(currentPage + 1)}
