...
export function Profile() {
    // useEffect(() =>{}
    const [name,setName]=useState("user Not Login")
    const [studentDetail ,SetStudentDetail ]=useState("student detail not available")
  return (
        ...
        {Array.from({ length: 1 }).map((_, i) => (
          <div key={i} className="mx-auto w-[300px] rounded-md border">
            ...
            <div className="p-4">
              ...
              <h6 className="mt-3 font-medium">{studentDetail}</h6>
